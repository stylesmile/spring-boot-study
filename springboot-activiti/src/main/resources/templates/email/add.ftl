                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal form-bordered" id="slifeForm">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> 用户id: <span class="required">  *  </span>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="userId"
                                       value="${email.userId}" required aria-required="true"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> 用户名称: <span class="required">  *  </span>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="name"
                                       value="${email.name}" required aria-required="true"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> 内容: <span class="required">  *  </span>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="content"
                                       value="${email.content}" required aria-required="true"/>
                            </div>
                        </div>
